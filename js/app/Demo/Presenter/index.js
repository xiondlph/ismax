App.Demo.View.Index = {
  List: Backbone.View.extend({
    ...
    initialize: function(){
      this.collection = new App.Demo.Collection.Review();
    },
  
    render: function(){
      var me = this;
      var tmpl = _.template(App.Demo.Templates.Index.List);
      me.$el.html(tmpl);
    ...
    renderReview: function(item){
      var reviewView = new App.Demo.View.Index.Item({model: item});
  ...
  Item: Backbone.View.extend({
    ...
    render: function(){
      var tmpl = _.template(App.Demo.Templates.Index.Item);
    ...
    render: function(){
      var tmpl = _.template(App.Demo.Templates.Index.Form);
      this.$el.append(tmpl);
    ...
    submit: function(e){      
    	var me = this;
      $.ajax({
        url: 'http://e-ismax.ru/review/set/',
        type: 'POST',
        dataType: 'json',
        data: JSON.stringify({
